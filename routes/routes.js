...
import {
  UserloginAll, SignupAdmin, Adminlogin, getAllGalleryController, deleteGalleryController, AddAdminBlogController, AdmindeleteBlogController, AddAdminCategoryController,AddAdminLeadController,AddAdminOrderController,AddAdminBookingController,getMedicalIdAdminController,getOrderIdAdminController
...
router.post('/admin/add-booking', AddAdminBookingController);
...
router.get("/all-hospital-doctor", getAllHospitalDotor);
